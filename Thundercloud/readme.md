...
<p>
    ...
    The airplane will climb from 8,000 feet to 12,000 feet to go over cloud 1.  Followed by a descent to an altitude of 2,000 feet.   finish by climbing up to 8,000 feet in the end from the low of 2,000 feet.  
...
<p>
    <img src="https://i.ibb.co/CW3vjfg/example.jpg" width="756" height="405" alt=""  />
</p>
...
<ul>
    ...
    The Flow is presented in 2 ways: a table and a plot. The table shows several nodes the aircraft will stay during the flight. And the actual flight flow will just be like a piecewise linear function with breaking point being these nodes. To be more explicitly, the flow will be displayed in the plot. The 3 vertical lines shown in the figure will be the 3 thunderstorms set. An default will be shown in the next part.</li>
