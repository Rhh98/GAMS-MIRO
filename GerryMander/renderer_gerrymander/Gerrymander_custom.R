...
gerryPlusPatternOutput <- function(id, height = NULL, options = NULL, path = NULL){
    ns <- NS(id)
...
renderGerryPlusPattern <- function(input, output, session, data, options = NULL, path = NULL, views = NULL, ...){ 
    #renderer 
